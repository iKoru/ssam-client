    ...
    <v-layout>
      <v-flex>
        <v-form ref="form" v-model="valid" lazy-validation>
          ...
          <span><router-link to="/signup">아직 회원이 아니신가요?</router-link><span v-if="$vuetify.breakpoint.smAndUp"> | </span><br v-else></br><router-link to="/resetPassword">비밀번호를 잊으셨나요?</router-link></span>
        </v-form>
      </v-flex>
    </v-layout>
  </v-container>
