...
<script>
const reserved = ['document', 'documents', 'profile', 'profiles', 'auth', 'user', 'users', 'comment', 'comments', 'vote', 'votes', 'report', 'reports', 'index', 'scraps', 'scrap', 'board', 'boards', 'manage', 'manages', 'chat', 'chats', 'message', 'messages', 'group', 'groups', 'event', 'events', 'signup', 'signin', 'signout', 'resetPassword', 'notification', 'notifications', 'survey', 'list', 'admin', 'ADMIN', 'ADMINISTRATOR', 'administrator', 'attach', 'profiles', 'animal', 'loungeBest', 'topicBest', 'lounge', 'topic', 'type', 'best', 'sanction', 'userId', 'nickName', 'myPage', 'myBoard', 'myCommunity', 'pedagy', 'myPedagy', 'Pedagy', 'tools', 'privacy', 'contract', 'rules', 'error', 'search', 'searchBoard', 'searchDocument', 'myBoard', 'myDocument', 'myComment', 'authSubmit', 'recent'];
