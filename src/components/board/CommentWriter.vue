  ...
  <v-layout column>
    ...
    <v-flex class="comment-writer-actions">
      <v-layout row align-center py-2 pr-2 :justify-end="$vuetify.breakpoint.xsOnly">
        ...
        <v-btn @click="selectImage" small flat class="my-0 ml-3" :icon="$vuetify.breakpoint.xsOnly" :disabled="isCommentWritable !== 'AVAILABLE' && isCommentWritable !== 'NEEDSUBSCRIPTION'">
